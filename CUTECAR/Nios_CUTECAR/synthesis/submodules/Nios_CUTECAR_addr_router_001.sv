...
(
    ...
    localparam PAD15 = log2ceil(64'h3000 - 64'h2800); 
    localparam PAD16 = log2ceil(64'h3010 - 64'h3000); 
    localparam PAD17 = log2ceil(64'h3020 - 64'h3010); 
    localparam PAD18 = log2ceil(64'h3028 - 64'h3020); 
    localparam PAD19 = log2ceil(64'h6000000 - 64'h4000000); 
    // -------------------------------------------------------
    ...
    // ( 0x140 .. 0x150 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 27'h140   ) begin
    ...
    // ( 0x2800 .. 0x3000 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 27'h2800   ) begin
            src_channel = 20'b00000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h3000   ) begin
            src_channel = 20'b00000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x3010 .. 0x3020 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 27'h3010   ) begin
            src_channel = 20'b00000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x3020 .. 0x3028 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 27'h3020   ) begin
